...
public class asklocation extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMyLocationClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nickaddress = findViewById(R.id.nickname_other_edittext);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        savebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Customer customer = new Customer(firstname, lastname, emailid, phonenum, city);
                ...
                db.collection("Customers").document(userid).set(customer).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
